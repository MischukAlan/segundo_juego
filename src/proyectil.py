...
class Proyectil():
    def __init__(self, pos_x, pos_y, direccion):
        ...
        self.sprite_sheet = SpriteSheet(pygame.image.load("./src/assets_2/caballero/_acha_2.png"))
        self.rect = pygame.rect.Rect(pos_x, pos_y, 5, 5) 
        self.velocidad = VELOCIDAD_DISPARO
        self.direccion = direccion
        self.contador_frames = 0
        self.image, self.cantidad_frames = self.sprite_sheet.get_imagen(self.contador_frames, 30, 20)
